...
//        this(context, R.style.dialog_common);  2017.5.4 修改
        this(context, android.support.v7.appcompat.R.style.AlertDialog_AppCompat);
    }
...
//        contentPadding = (int) getContext().getResources().getDimension(R.dimen.global_dialog_padding); 2017.5.4 修改
//        contentPadding = (int) getContext().getResources().getDimension(android.R.dimen.app_icon_size);
//        init(context);
    }
