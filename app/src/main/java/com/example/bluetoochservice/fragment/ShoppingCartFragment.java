package com.example.bluetoochservice.fragment;
...
import com.example.bluetoochservice.activity.ConfirmOrderActivity;
import com.example.bluetoochservice.activity.MyOrderListActivity;
import com.example.bluetoochservice.activity.OrderDetailActivity;
import com.example.bluetoochservice.adapter.ShoppingCartAdapter;
import com.example.bluetoochservice.base.BaseFragment;
...
public class ShoppingCartFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        startView = (View) rootView.findViewById(R.id.start);
